                            ...
                            <CardContent className="p-4 md:p-6 grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
                                ...
                                <div className="sm:col-span-2 pt-4 border-t border-gray-100">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <div className="h-8 w-8 rounded-full bg-slate-100 flex items-center justify-center text-slate-700 text-xs font-bold">
                                    ...
                                    {comments.length === 0 ? (
                                        ...
                                        comments.map((comment, index) => (
                                            <div key={comment.id} className="flex gap-3 text-sm">
                                                <div className="h-8 w-8 rounded-full bg-slate-100 text-slate-600 flex items-center justify-center font-bold text-xs shrink-0 uppercase border border-slate-200">
                            ...
                            <CardContent className="p-4 md:p-6 space-y-3">
                                <div className="flex items-center justify-between bg-white p-3 rounded-lg border border-gray-200 shadow-sm">
                                    ...
                                    <Button
                                        ...
                                        className="h-8 text-xs shrink-0 border-slate-200 hover:bg-slate-50 hover:text-slate-900 font-medium"
                                    >
                                        Copy Link
                                    </Button>
                                </div>
                                ...
                                <div className="mt-2 text-right">
                                    <Link href={`/track/${booking.tracking_id}`} target="_blank" className="text-xs font-bold text-slate-900 hover:underline flex items-center justify-end gap-1">
                                        Open Tracking Page →
                                    </Link>
                                </div>
                            </CardContent>
            ...
            <Modal isOpen={isUpdateModalOpen} onClose={() => setIsUpdateModalOpen(false)} title="Update Booking Details">
                <div className="space-y-6 pt-2 h-[75vh] overflow-y-auto pr-2 custom-scrollbar">
                    ...
                    <div className="space-y-4">
                        ...
                        {/* Notifications */}
                        <div className="mt-4 bg-slate-50/50 p-3 rounded-lg border border-slate-100">
                            <label className="text-xs font-bold text-slate-800 mb-2 block flex items-center gap-1">
